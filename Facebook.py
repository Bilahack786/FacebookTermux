...
logo = """
   SBH
  ™Ꭰᥲʀκ͢❥Ӄᴎ͟͞ɪ͟͞ԍ͟͞ʜ͟͞ᴛ™𝐒𝐁𝐇]
   𝐭𝐡𝐢𝐬 S𝐡𝐚𝐢𝐤𝐡 B𝐢𝐥𝐚𝐰𝐚𝐥 𝐡𝐚𝐜𝐤𝐞𝐫 TRICKER 
   𝐢 𝐥𝐨𝐯𝐞 𝐡𝐚𝐜𝐤
   𝐭𝐡𝐢𝐬 𝐚𝐥𝐥 H𝐚𝐜𝐤𝐬 𝐚𝐯𝐚𝐢𝐥𝐚𝐛𝐥𝐞 𝐡𝐞𝐚𝐫
   𝐒𝐁𝐇 P𝐀𝐊𝐈𝐒𝐓𝐀𝐍 𝐇𝐀𝐂𝐊𝐄𝐑𝐒 𝐓𝐄𝐀𝐌
   ™Ꭰᥲʀκ͢❥Ӄᴎ͟͞ɪ͟͞ԍ͟͞ʜ͟͞ᴛ™𝐒𝐁𝐇]
\033[1;91m=======================================
...
\033[1;91m======================================="""
print " \x1b[1;93m============================================================="
CorrectUsername = "🆂🅱🅷 𝐔𝐒𝐄𝐑𝐍𝐀𝐌𝐄"
CorrectPassword = "🆂🅱🅷 𝐏𝐀𝐒𝐒𝐖𝐎𝐑𝐃"
loop = 'true'
while (loop == 'true'):
